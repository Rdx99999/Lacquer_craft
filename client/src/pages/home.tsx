            ...
            <div className="text-left space-y-6 lg:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-4 pt-4">
                <Link href="/products" className="w-full sm:w-auto">
                  <Button className="bg-terracotta hover:bg-terracotta/90 text-white px-8 py-4 text-base font-serif font-semibold w-full sm:w-auto traditional-shadow hover:scale-105 transition-all duration-300 craft-border border-0">
